...
![esp32](https://github.com/user-attachments/assets/8a0b5a0b-5bbe-42c5-8a0a-bfdda2b95b47)
...
void setup() {
  ...
  wifiMulti.addAP("Smart Methods", "123456789");
}
...
void loop() {
  ...
  if ((wifiMulti.run() == WL_CONNECTED)) {
    ...
    http.begin("https://s-m.com.sa/r2/test/t.html");  //HTTP
